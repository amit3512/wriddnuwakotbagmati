...
if (staffs === undefined) {
    return <h4 alt="loading..." className="text-center mt-5"> Loading Staff... </h4>
  }
    return(
        <div>
                ...
                <div className="row">
                             ...
                             <table className="table table-border">
                                 ...
                                 {staffs && staffs.map((user,index)=>{
                                        ...
                                        <tbody>
                                            ...
                                            <td>{user.phone}</td>
                                            <td>{user.email}</td>
                                             <td ><img  src={user.image} className="listing-images" alt="profile img"/></td>
                    ...
                    <div className="col-md-2">
                            <div className="add-button">
                                <a href="/admin/addStaff"><button className="btn btn-primary">Add Staff</button></a>
                            </div>
                    </div>
                </div>
            </div>
