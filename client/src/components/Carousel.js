...
function Carousel() {
  return (
                    ...
                    <div id="my-carousel" className="carousel slide carousel-fade" data-ride="carousel" data-interval="2000">
                        ...
                        <div className="carousel-inner">
                            <div className="carousel-item active">
                                <img className="d-block w-100 carousel-image" src={slider} alt="First slide"/>
                            </div>
