          ...
          <div className="col-md-4">
            <div className="card">
              <div className="card-body">
                ...
                <a href="/gallery/Event" className="btn btn-primary">
                  Visit
                </a>
              </div>
            </div>
          ...
          <div className="col-md-4">
            <div className="card">
              <div className="card-body">
                ...
                <a href="/gallery/Training" className="btn btn-primary">
                  Visit
                </a>
              </div>
            </div>
          ...
          <div className="col-md-4">
            <div className="card">
              <div className="card-body">
                ...
                <a href="/gallery/Office" className="btn btn-primary">
                  Visit
                </a>
              </div>
            </div>
          ...
          <div className="col-md-4">
            <div className="card">
              <div className="card-body">
                ...
                <a
                  href="/gallery/Nagarik-WadaPatra"
