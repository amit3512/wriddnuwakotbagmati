...
export const addStaff = (formData) => async (dispatch) => {
  await axios
    .post(`${serverurl}/admin/staffs/add`, formData, {
      headers: {
...
export const updateStaff = (id, formData) => async (dispatch) => {
  await axios
    .put(`${serverurl}/admin/staffs/update/${id}`, formData, {
      headers: {
...
export const deleteStaff = (id) => async (dispatch) => {
  axios
    .delete(`${serverurl}/admin/staffs/delete/${id}`, {
      headers: {
        "Content-Type": "application/json",
      },
    })
...
export const addNotice = (formData) => async (dispatch) => {
  await axios
    .post(`${serverurl}/admin/notices/add`, formData, {
      headers: {
        "Content-Type": "application/json",
      },
    })
...
export const getNotice = (id) => async (dispatch) => {
  if (id) {
    const users = await axios
      .get(`${serverurl}/admin/notices/${id}`)
      .then((res) => {
        return res.data;
      });
...
export const updateNotice = (id, formData) => async (dispatch) => {
  await axios
    .put(`${serverurl}/admin/notices/update/${id}`, formData, {
      headers: {
        "Content-Type": "application/json",
      },
    })
...
export const deleteNotice = (id) => async (dispatch) => {
  axios
    .delete(`${serverurl}/admin/notices/delete/${id}`, {
      headers: {
        "Content-Type": "application/json",
...
export const addMessage = (formData) => async (dispatch) => {
  await axios
    .post(`${serverurl}/admin/messages/add`, formData, {
      headers: {
        "Content-Type": "application/json",
      },
    })
...
export const updateMessage = (id, formData) => async (dispatch) => {
  await axios
    .put(`${serverurl}/admin/messages/update/${id}`, formData, {
      headers: {
        "Content-Type": "application/json",
      },
    })
...
export const addEvent = (formData) => async (dispatch) => {
  await axios
    .post(`${serverurl}/admin/events/add`, formData, {
      headers: {
        "Content-Type": "application/json",
      },
    })
...
export const updateEvent = (id, formData) => async (dispatch) => {
  await axios
    .put(`${serverurl}/admin/events/update/${id}`, formData, {
      headers: {
        "Content-Type": "application/json",
      },
    })
...
export const addPhoto = (formData) => async (dispatch) => {
  await axios
    .post(`${serverurl}/admin/galleries/multiple`, formData, {
      headers: {
        "Content-type": "multipart/form-data",
      },
    })
...
export const getPhoto = (category) => async (dispatch) => {
  if (category) {
    var galleries = await axios
      .get(`${serverurl}/admin/galleries/${category}`)
      .then((res) => {
        return res.data;
      });
  } else {
...
export const getPhotoByTitle = (title) => async (dispatch) => {
  var galleries = await axios
    .get(`${serverurl}/admin/galleries/title/${title}`)
    .then((res) => {
      return res.data;
    });
